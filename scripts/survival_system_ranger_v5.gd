...
# v0.48: preserve ranger-first scene isolation while attaching the Forest runtime
# with movement-driven camera bow sway and wounded wildlife anti-orbit fleeing.
func _ready() -> void:
    ...
    _attach_runtime("ForestSurvivalRuntime", "res://scripts/forest_survival_system_v48.gd")
