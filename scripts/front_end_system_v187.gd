...
const VERSION_BADGE_TEXT_V56: String = "v0.56  •  CO-OP SUPPLY SCALING  •  POWERED SAFE ZONE"
...
func _process(delta: float) -> void:
    ...
    if version_label != null and version_label.text != VERSION_BADGE_TEXT_V56:
        version_label.text = VERSION_BADGE_TEXT_V56
