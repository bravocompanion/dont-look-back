...
# v0.49: preserve ranger-first scene isolation while attaching the Forest runtime
# with one-shot stretched draw audio, shoot/impact audio, and persistent corpses.
func _ready() -> void:
    ...
    _attach_runtime("ForestSurvivalRuntime", "res://scripts/forest_survival_system_v49.gd")
