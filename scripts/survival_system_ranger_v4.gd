...
# v0.46: keep ranger-first scene isolation while attaching the hold-to-draw
# Forest runtime whose physical arrows stick to living wildlife targets.
func _ready() -> void:
    ...
    _attach_runtime("ForestSurvivalRuntime", "res://scripts/forest_survival_system_v46.gd")
