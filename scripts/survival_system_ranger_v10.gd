...
# v0.53: ranger-first runtime with hard species movement caps and stronger
# single-layer bow draw sway while preserving v0.52 carcass harvesting and
# all v0.51 Tenant night/light rules.
func _ready() -> void:
    ...
    _attach_runtime("ForestSurvivalRuntime", "res://scripts/forest_survival_system_v53.gd")
